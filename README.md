# `Pango_jll.jl` (v1.58.2+0)

[![deps](https://juliahub.com/docs/Pango_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Pango_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/b35a3baf2a5e1d72db00b00a4e7b8d90d8e9ca42/P/Pango/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: http://ftp.gnome.org/pub/GNOME/sources/pango/1.58/pango-1.58.2.tar.xz (SHA256 checksum: `342385b6ca3b7c73455d7c80a13b7dbe4489e00bc3bd4c5bd6ed4dce421e374a`)
